...
export const metadata = {
  title: "Cookie Policy | Rely Tech Serve",
  description: "Cookie policy for Rely Tech Serve - how we use cookies and similar technologies.",
};
    ...
    <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-slate prose-lg max-w-none">
          ...
          <p>
            Rely Tech Serve uses cookies and similar technologies to provide, secure, and improve
            our website. We use both first-party cookies (set by us) and third-party cookies (set
          ...
          <p>
            We use Google Analytics (G-PW2H8496C5) to understand how visitors use our website.
            These cookies collect information such as pages visited, time on site, and referral
            sources. This helps us improve our website and services.
          </p>
          <table className="w-full text-sm border-collapse border border-slate-300">
            <thead>
              <tr className="bg-slate-100">
                <th className="border border-slate-300 p-2 text-left">Cookie</th>
                <th className="border border-slate-300 p-2 text-left">Provider</th>
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-slate-300 p-2">Distinguishes users</td>
              </tr>
              <tr>
                <td className="border border-slate-300 p-2">_ga_*</td>
                <td className="border border-slate-300 p-2">Google Analytics</td>
                <td className="border border-slate-300 p-2">Persists session state</td>
              </tr>
              <tr>
          ...
          <p>
            ...
            to accept all cookies, accept only necessary cookies, or manage your preferences. Your
          ...
          <p>
            Our website may include content or services from third parties (e.g. Google Analytics).
            These providers may set their own cookies. We encourage you to review their privacy
            policies:
          </p>
          <ul>
            <li>
